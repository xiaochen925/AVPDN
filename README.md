...
Our code has been uploaded to GitHub at the link provided in the manuscript: https://github.com/xiaochen925/AVPDN. This repository is set to public access—no permission or login is required for anyone to view and download the code (users can directly click the "Code" button to download all files). 
